...
const metaCells = [
  {
    ...
    v: (
      <>
        ...
        <strong style={{ color: 'var(--ink)' }}>ambitious startups</strong> &amp; design-led
        teams.
      </>
    ),
  },
  {
    ...
    v: (
      <>
        <strong style={{ color: 'var(--ink)' }}>6 years</strong> shipping to production. 40+
        projects.{' '}
        <em
          style={{
      ...
      >
        <div>
          ...
          >
            ...
            <br />
            product{' '}
            <em style={{ color: 'var(--accent)', fontStyle: 'normal' }}>beautiful</em> and fast.
          </motion.p>
          ...
          >
            ...
            >
              <span className="w-6 h-px" style={{ background: 'var(--muted)', opacity: 0.35 }} />
        ...
        >
          ...
          >
            I work closest to the interface — turning designs into fast, accessible, and
            maintainable code — but I'm equally at home wiring up APIs, databases, and{' '}
            <em
              style={{
                fontFamily: 'Instrument Serif, serif',
                fontStyle: 'italic',
      ...
      <div className="flex flex-col justify-between px-14 pt-14 pb-20 max-md:px-5 max-md:pt-8 max-md:pb-12">
        ...
        >
          ...
          <div
            ...
            style={{ padding: '12px 16px', borderColor: 'var(--line)', color: 'var(--muted)' }}
          >
          ...
          {metaCells.map(({ k, v }, i) => (
            ...
            >
              <div
                ...
                style={{ letterSpacing: '0.12em', color: 'var(--muted)', marginBottom: '7px' }}
              >
                {k}
              </div>
