...
export const experience = [
  ...
  },
  {
    ...
    description:
      "First engineering hire. Built the MVP. Learned what happens when you skip tests (don't).",
    tags: ["Vue", "Firebase"],
  },
];
...
export const services = [
  ...
  },
  {
    ...
    features: [
      "Figma → production in weeks",
      "Sanity / Contentlayer / MDX",
      "Webgl / scroll choreography",
    ],
    icon: "browser",
  },
  {
  ...
  },
  {
    ...
    features: [
      "Core Web Vitals to green",
      "Bundle & render-path audit",
      "DB + API latency reviews",
    ],
    icon: "trending-up",
  },
];
...
export const projects = [
  {
    ...
    year: "'26",
    description:
      "An in-browser tool for previewing fluid type scales across viewports. 12k+ monthly users.",
    tags: ["React", "OSS"],
  ...
  },
  {
    ...
    year: "'24",
    description:
      "A local-first markdown journaling app. Built in a weekend as a Tauri + SolidJS experiment.",
    tags: ["Tauri", "Solid"],
